...
// Bare beam (no spring). Freq ratios remain empirical (7.11, 20.25).
// =================================================================
// Per-key spatial ratios at striking position [beam1/fund, beam2/fund]
// Index: (midi - 21) * 2.  MIDI range: 21-108 (keys 1-88)
var BEAM_SPATIAL_RATIO = new Float32Array([
  -2.934255,  2.638158, -2.884621,  2.491381, -2.833217,  2.343150,
  -2.782070,  2.198219, -2.731515,  2.059004, -2.679291,  1.917439,
  -2.630060,  1.788257, -2.574665,  1.645276, -2.520828,  1.510999,
  -2.471785,  1.392473, -2.422799,  1.277295, -2.370626,  1.157938,
  -2.319382,  1.044395, -2.267577,  0.932648, -2.219462,  0.833614,
  -2.166308,  0.725926, -2.115307,  0.627367, -2.063000,  0.529512,
  -2.012818,  0.439664, -1.966120,  0.360431, -1.919122,  0.283153,
  -1.867147,  0.200565, -1.816602,  0.123592, -1.768652,  0.054857,
  -1.720774, -0.010109, -1.673328, -0.071679, -1.627827, -0.127061,
  -1.582670, -0.178343, -1.536946, -0.228509, -1.491635, -0.274334,
  -1.446177, -0.309229, -1.403692, -0.346772, -1.362012, -0.380249,
  -1.322576, -0.408880, -1.283933, -0.433982, -1.246213, -0.455986,
  -1.210730, -0.474790, -1.172946, -0.493824, -1.139805, -0.507200,
  -1.101778, -0.523056, -1.068081, -0.521356, -1.037513, -0.526960,
  -1.009336, -0.531883, -0.983566, -0.533315, -0.958223, -0.534288,
  -0.935761, -0.533273, -0.913590, -0.531406, -0.888738, -0.528452,
  -0.880717, -0.520289, -0.858795, -0.515762, -0.833442, -0.497932,
  -0.820943, -0.491350, -0.812511, -0.480639, -0.803432, -0.470615,
  -0.798227, -0.460651, -0.794158, -0.448907, -0.793072, -0.437133,
  -0.794921, -0.423848, -0.807577, -0.401923, -0.805955, -0.392257,
  -0.816420, -0.371700, -0.829240, -0.350720, -0.844301, -0.327113,
  -0.863655, -0.297610, -0.885286, -0.265395, -0.907277, -0.232886,
  -0.937368, -0.188629, -0.963585, -0.148149, -1.000400, -0.090881,
  -1.034036, -0.034870, -1.078605,  0.036050, -1.122755,  0.119293,
  -1.175012,  0.214365, -1.225240,  0.312463, -1.281642,  0.427811,
  -1.341857,  0.554402, -1.405990,  0.695161, -1.475061,  0.854175,
  -1.549217,  1.024495, -1.630523,  1.227854, -1.708180,  1.419154,
  -1.795156,  1.639195, -1.887211,  1.874816, -1.983506,  2.126810,
  -2.083056,  2.389773, -2.188787,  2.675396, -2.300167,  2.978705,
  -2.415471,  3.304614
]);
...
var BEAM_PHI_STRIKE = new Float32Array([
  0.196392, 0.201369, 0.206535, 0.211779, 0.216962, 0.222457,
  0.227607, 0.233567, 0.239360, 0.244647, 0.249976, 0.255731,
  0.261426, 0.267287, 0.272663, 0.278826, 0.284714, 0.290859,
  0.296776, 0.302230, 0.307819, 0.314151, 0.320389, 0.326292,
  0.332217, 0.338181, 0.343899, 0.349580, 0.355486, 0.361335,
  0.366670, 0.372257, 0.377723, 0.382869, 0.387902, 0.392814,
  0.397456, 0.402543, 0.406866, 0.412122, 0.415678, 0.419557,
  0.423185, 0.426308, 0.429414, 0.432032, 0.434593, 0.437520,
  0.437520, 0.439940, 0.441652, 0.442466, 0.442206, 0.442109,
  0.441329, 0.440154, 0.438464, 0.436071, 0.431257, 0.429638,
  0.425222, 0.420338, 0.414951, 0.408321, 0.401230, 0.394136,
  0.384987, 0.376856, 0.366227, 0.356006, 0.344242, 0.331303,
  0.317302, 0.303852, 0.288960, 0.273354, 0.257253, 0.240276,
  0.222891, 0.204532, 0.186800, 0.168290, 0.150098, 0.131996,
  0.114275, 0.099005, 0.085550, 0.073562
]);
...
class EpianoWorkletProcessor extends AudioWorkletProcessor {
  ...
  _noteOn(midi, velocity) {
    ...
    // Spatial excitation from FEM tapered beam mode shapes
    // Pre-computed by tools/compute_tapered_modes.py (Third Stage taper)
    // Band-integrated at striking position with hammer tip width
    var L_mm = tineLength(midi);
    var keyIdx = midi - 21;
    var spatialRatio1, spatialRatio2;
    if (keyIdx >= 0 && keyIdx < 88) {
      spatialRatio1 = BEAM_SPATIAL_RATIO[keyIdx * 2];
      spatialRatio2 = BEAM_SPATIAL_RATIO[keyIdx * 2 + 1];
    } else {
      // Fallback to uniform E-B for out-of-range MIDI
      ...
      var sBeam1 = bandModeExcitation(xi, bandNorm, 1);
      var sBeam2 = bandModeExcitation(xi, bandNorm, 2);
      spatialRatio1 = sBeam1 / Math.max(Math.abs(sFund), 0.001);
      spatialRatio2 = sBeam2 / Math.max(Math.abs(sFund), 0.001);
    }
